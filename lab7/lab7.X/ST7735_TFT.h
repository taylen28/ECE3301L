...
#define TFT_DC      PORTCbits.RC5       // TFT D/C
#define TFT_CS      PORTDbits.RD2       // TFT Chip Select
#define TFT_RST     PORTDbits.RD5       // TFT Reset
...
// Define BOOL for backward compatibility
#ifndef BOOL
#define BOOL bool
#endif
